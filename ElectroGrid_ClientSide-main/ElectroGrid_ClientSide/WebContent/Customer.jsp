...
<script src="components/main.js"></script>
    ...
    <title>ELECTRO GRID - Customer Management</title>
		 ...
		 <br>
            <div class="container col-md-5">
				...
				<form id="formCustomer" name="formCustomer" method="post" action="Customer.jsp">  
					Name:  
					<input id="customerName" name="customerName" type="text" required="" class="form-control form-control-sm">  
					
					<br> 
					Address:  
					<input id="customerAddress" name="customerAddress" type="text" required=""  class="form-control form-control-sm">  
					
					<br>
					 Email:  
					 <input id="customerEmail" name="customerEmail" type="text" pattern="[^ @]*@[^ @]*" required="" class="form-control form-control-sm"> 
					 
					 <br>
					 Date:  
					 <input id="customerDate" name="customerDate" type="text" required="" class="form-control form-control-sm">  
					 
					 <br> 
					 Phone Number:  
					 <input id="customerContact" name="customerContact" type="text" pattern="^\d{10}$" required="" class="form-control form-control-sm">  
